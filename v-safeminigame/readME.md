# v-safeminigame Documentation

## Overview

**v-safeminigame** is a FiveM NUI-based safe cracking minigame where players must align 3 rotating dials to match a hidden combination. It supports full Lua → NUI integration, callbacks, sounds, and export-based usage.
